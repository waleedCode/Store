                ...
                <div class="card-body">
                    <form action="{{ url('update.client'.$client->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="id"  value="{{$client->id}}" readonly id="identity_umber" class="form-control" required>
                        </div>
                        <div class="form-group mb-3">
                            <label for="identity_umber">رقم الهوية </label>
                            <input type="text" name="identity_umber"  value="{{$client->identity_number}}" id="identity_umber" class="form-control" required>
                        </div>

                        
                        <div class="form-group mb-3">
                            <label for="full_name"> الاسم ثلاثي </label>
                            <input type="text" name="full_name" id="full_name" value="{{$client->full_name}}" class="form-control" required>
                        </div>
                        <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="nationality"  value="{{$client->nationality}}" class="form-control" required>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="confirm_password" value="{{$client->password_confirmation}}"  class="form-control" required>
                        </div>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary col-lg-4" style="margin-right: 30%;">تحديث البيانات </button>
                        </div>
