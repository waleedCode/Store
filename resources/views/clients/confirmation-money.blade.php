                ...
                <div class="card-body">
                    <form action="{{ route('clients.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            <label for="identity_umber"> الرمز </label>
                        ...
                        <div class="form-group mb-3">
                            <label for=""> المبلغ المحول </label>
                            <input type="text" name="nationality" class="form-control" required>
                        </div>
                        <div class="form-group mb-3">
                          <label for=""> تغيير المبلغ </label>
                          <input type="text" name="nationality" class="form-control" required>
                      </div>
                      
                      
                          <div >
                            <img src="money.jpg" alt="Girl in a jacket" width="100%" height="700">
                          </div>
