                ...
                <div class="card-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="identity_umber" id="identity_umber" value="B100" class="form-control" required>
                        </div>
                        <div class="form-group mb-3">
                            <label for="identity_umber">رقم السجل	  </label>
                            <input type="text" name="identity_umber" id="identity_umber" class="form-control" required>
                        </div>

                        
                        <div class="form-group mb-3">
                            <label for="full_name">  الاسم التجاري	 </label>
                            <input type="text" name="full_name" id="full_name" class="form-control" required>
                        </div>

                        <div class="form-group mb-3">
                          <label for="full_name">  رقم ترخيص  النقليات	 </label>
                          <input type="text" name="full_name" id="full_name" class="form-control" required>
                      </div>
                        ...
                        <div class="form-group mb-3">
                            <label for="email"> رقم الايبان IBAN	</label>
                      ...
                      <div class="form-group mb-3">
                        ...
                        <div class="file-upload">
                          <button class="file-upload-btn" type="button" onclick="$('.file-upload-input').trigger( 'click' )">  صورة السجل التجاري </button>
                        ...
                        <script class="jsbin" src="https://ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js"></script>
                        <div class="file-upload">
                          <button class="file-upload-btn" type="button" onclick="$('.file-upload-input').trigger( 'click' )">  صورة الحساب البنكي </button>
