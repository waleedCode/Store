...
<h2> بيانات  السائقين   </h2>
</div>
<div class="pull-right mb-2">
<a class="btn btn-success" href="{{ url('create-drivers') }}"> <i class="fas fa-plus"></i>اضافة سائق  </a>
</div>
</div>
</div>
...
<th>الجنسية</th>
<th class="col-md-1">صورة الرخصة</th>
...
<th width="280px">
  <a class="btn btn-success"  href="{{ url ('drivers-edit') }}">تعديل</a>
