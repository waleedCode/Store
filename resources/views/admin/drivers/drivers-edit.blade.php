            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('clients.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                          <label for="identity_umber">رمز الشركه </label>
                          <input type="text" name="identity_umber" id="identity_umber" class="form-control" required>
                      </div>
                        <div class="form-group mb-3">
                        ...
                        <fieldset>
                          <div>
                            ...
                            <label for="horns"> محفظة (x1) عميل مشترك لدينا   </label>
                          </div>
                        ...
                        <div class="file-upload col-md-4" >
                          <button class="file-upload-btn" type="button" onclick="$('.file-upload-input').trigger( 'click' )">اضافة الصورة هوية السائق </button>
                        ...
                        <script class="jsbin" src="https://ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js"></script>
                        <div class="file-upload col-md-4">
                          <button class="file-upload-btn" type="button" onclick="$('.file-upload-input').trigger( 'click' )">اضافة   صورة الرخصة </button>
