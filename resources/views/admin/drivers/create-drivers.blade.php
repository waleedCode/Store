                ...
                <div class="card-body">
                    <form action="{{ route('clients.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            <label for="identity_umber">رمز السائق </label>
                        ...
                        <div class="form-group mb-3">
                          <label for=""> تاريخ انتهاء الرخصة </label>
                      ...
                      <div class="form-group mb-3">
                        <label for=""> رقم حساب الايبان IBAN </label>
                        <input type="text" name="nationality" class="form-control" required>
                    </div>
                        ...
                        <div class="file-upload">
                          <button class="file-upload-btn" type="button" onclick="$('.file-upload-input').trigger( 'click' )">اضافة الصورة الهوية </button>
                        ...
                        <script class="jsbin" src="https://ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js"></script>
                        <div class="file-upload">
                          <button class="file-upload-btn" type="button" onclick="$('.file-upload-input').trigger( 'click' )">صورة الحساب البنكي IBAN   </button>
                        ...
                        <script class="jsbin" src="https://ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js"></script>
                        <div class="file-upload">
                          <button class="file-upload-btn" type="button" onclick="$('.file-upload-input').trigger( 'click' )">صورة  الرخصة     </button>
