...
<th class="col-md-3">رقم حساب الايبان IBAN</th>
<th class="col-md-2">البريد الاكتروني</th>

<th width="280px">ايقافات</th>
<th width="280px">حذف الايقاف</th>
...
<th>
  <a class="btn btn-success" href="{{ url ('stop-clients-tasks') }}">ايقافات</a>

</th>
<th>
  <a class="btn btn-danger" href="{{ url ('stop-clients') }}">حذف</a>
