...
<div class="card" style="width: 18rem;">
  <div class="card-body">
    <h5 class="card-title"> ايداعات العملاء</h5>
    <i class="material-icons">account_circle</i>

    <a href="{{('deposits-clients')}}" class="btn btn-primary">فتح</a>
  </div>
</div>
<div class="card" style="width: 18rem;">
  <div class="card-body">
    <h5 class="card-title">  ايداعات السائقين </h5>
    <a href="{{('deposits-drivers')}}" class="btn btn-primary">فتح</a>
  </div>
</div>
