...
<div class="card" style="width: 18rem;">
  <div class="card-body">
    <h5 class="card-title">  الطلبات الجديدة للاشتراك</h5>

    <a href="{{('x1-new-order')}}" class="btn btn-primary">فتح</a>
  </div>
</div>
<div class="card" style="width: 18rem;">
  <div class="card-body">
    <h5 class="card-title">  الشركات المشتركة</h5>

    <a href="{{('x1-joint-companies')}}" class="btn btn-primary">فتح</a>
  </div>
</div>
<div class="card" style="width: 18rem;">
  <div class="card-body">
    <h5 class="card-title">    اضافة  مبالغ ومتابعة </h5>
    <a href="{{url ('x1')}}" class="btn btn-primary">فتح</a>
  </div>
</div>
