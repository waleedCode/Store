                ...
                <div class="card-body">
                    <form action="{{ route('clients.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            <label for="identity_umber"> رقم الطلب </label>
                            <input type="text" name="identity_umber" id="identity_umber" class="form-control" required placeholder="فاتورة الطلب">
                        </div>
                        <div class="form-group mb-3">
