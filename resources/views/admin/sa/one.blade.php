...
<a class="btn btn-success" href="{{ route('') }}"> <i class="fas fa-plus"></i>اضافة عميل  </a>
</div>
</div>
</div>
...
<th >رمز العميل</th>
<th class="col-md-3">رقم الهوية  </th>
<th class="col-md-3">الإسم ثلاثي  </th>
<th class="col-md-3">رقم الجوال</th>
<th>الجنسية</th>
<th class="col-md-4">البريد الاكتروني</th>
...
<th width="280px">
  <a class="btn btn-success"  href="{{ url ('') }}">تعديل</a>

</th>
<th>
  <a class="btn btn-success" href="{{ url ('') }}">ايقافات</a>
