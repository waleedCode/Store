...
<div class="pull-left">
  ...
  <div class="box">
    <select id="select">
      ...
      <option> رمز الشحن	</option>
      <option>رمز التسليم</option>
...
<th class="col-md-1"  > سعر النقل</th>
<th class="col-md-1" > نسبة البرنامج</th>
<th class="col-md-1" > تاريخ الطلب</th>
<th class="col-md-1" >رمز الشحن</th>
<th class="col-md-1" >رمز التسليم</th>
<th class="col-md-1">   الفاتورة</th>

</tr>
<tr>
  <th > 
    <a href="{{ url ('new-orders')}}">1</a>
    
  </th>
<th> 
  <a href="{{ url ('clients-data')}}">4</a>

</th>


<th> 
  <a href="{{ url ('drivers-data')}}">2</a>
...
<th style="background-color: rgb(202, 2, 2)">
    <label  >222</label>
