...
<div class="card" style="width: 18rem;">
  <div class="card-body">
    <h5 class="card-title text-center"> السعودية</h5>
    <a href=" {{url('/sa-admin')}}" class="btn btn-primary">فتح</a>
    <a href=" {{url('/sa-users')}}" class="btn btn-success">ادارة المستخدمين</a>
